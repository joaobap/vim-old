...
if exists('g:code_darker') && g:code_darker == 1
...
let s:cdSearchCurrent = {'gui': '#ffd75f', 'cterm': s:cterm09, 'cterm256': '221'}
let s:cdSearch = {'gui': '#ffd75f', 'cterm': s:cterm0A, 'cterm256': '221'}
